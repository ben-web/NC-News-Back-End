...
describe('NORTHCODERS NEWS API', () => {
  ...
  describe('/api/topics/:topic_slug/articles', () => {
    ...
    // ADD COMMENT COUNT FUNCT
    // Returns count of all commetns that match article ID in key 'comments'
    // returned key: comments

/*     it('GET articles by topic_slug includes comment count', () => {
      return request
        .get(`/api/topics/${topicDocs[0].slug}/articles`)
        .expect(200)
        .then(res => {
        ...
        // count all comments that relate to an article
